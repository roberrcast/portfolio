export const en = {
    ...
    description: {
        block1: "As a Front End developer, I lean on the <span>modern foundations</span> of React and TypeScript, leveraging Vite for its incredible development speed and Redux for robust, predictable state management in complex applications.",

        block2: "My workflow is built for precision and efficiency. I utilize Neovim and Bash for a streamlined, terminal-centric environment, while relying on Vitest and Postman to ensure every line of code and API interaction is thoroughly validated.",
    },
...
export const es = {
    ...
    stack: {
        ...
        sass: "Icono de Sass",
        vite: "Icono de Vite",
        redux: "Icono  de Redux",
        styled: "Icono de Styled Components",
        node: "Icono de Node JS",
        npm: "Icono de NPM",
        bash: "Icono de Bash",
        git: "Icono de Git",
        neovim: "Icono de Neovim",
        vitest: "Icono de Vitest",
        postman: "Icono de Postman",
